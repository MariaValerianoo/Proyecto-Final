...
public:
    ...
    void importarDatos(string nombreArchivo)
    {
        ...
        if (formato == "csv")
        {
            ...
            while (getline(archivoEntrada, linea))
            {
                ...
                {
                    if (linea.empty())
                        break; // Fin de las tareas de este proyecto
    ...
    void agregarTarea(string nombreProyecto)
    {
        ...
        cout << "Ingrese la fecha limite de la tarea (formato dd/mm/aaaa): " << endl;
...
private:
    ...
    void menuProyecto(string nombreProyecto)
    {
        while (true)
        {
            cout << "\nMenu del Proyecto " << nombreProyecto << ":" << endl;
            ...
            case 2:
                ...
                break;
            case 3:
                mostrarNotasProyecto(nombreProyecto); // Llamada al nuevo método
                break;
            case 4:
                mostrarNotasTarea(nombreProyecto); // Llamada al nuevo método
                break;
            case 5:
